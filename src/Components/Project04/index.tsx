        ...
        <div className="tablet:mb-[40px] desktop:w-[481px] mb-[48px]">
          ...
          <div>
            ...
            <p className="desktop:w-[357px] desktop:relative desktop:translate-x-0 desktop:translate-y-0 tablet:absolute tablet:translate-x-[325px] tablet:translate-y-[-67px] tablet:max-w-[375px] mb-[24px] max-w-[311px] text-neutral-700 text-[16px] leading-[30px] font-normal">
              This project is a responsive tip calculator built with HTML, CSS,
              and JavaScript. Users input bill amounts, select tip percentages,
              and specify the number of people. The calculator dynamically
              calculates tips and total bills for a seamless experience on all
              devices.
            </p>
          </div>
          <div>
            ...
            <Link
              to="https://sweet-sherbet-9753fb.netlify.app/"
              target="_blank"
            >
