        ...
        <div className="tablet:mb-[40px] desktop:w-[481px] mb-[48px]">
          ...
          <div>
            ...
            <p className="desktop:w-[357px] desktop:relative desktop:translate-x-0 desktop:translate-y-0 tablet:absolute tablet:translate-x-[325px] tablet:translate-y-[-67px] tablet:max-w-[375px] mb-[24px] max-w-[311px] text-neutral-700 text-[16px] leading-[30px] font-normal">
              This project requires building a React web app to manage credit
              card details, built with HTML, CSS and JavaScript-React. It has
              two main components: a header for visualizing the card and a body
              for input handling using React Hook Form.
            </p>
          </div>
          <div>
            ...
            <Link
              to="https://interactive-card-details-form-ten-lime.vercel.app/"
              target="_blank"
            >
        ...
        <div className="desktop:w-[638px] desktop:flex desktop:flex-col">
          ...
          <div className="mb-[72px] flex items-center flex-col">
            <div>
              ...
              <img
                className="mb-[32px] w-[311px] tablet:w-[689px] desktop:w-[1110px]"
                src={PortfolioImg02}
                alt="PortfolioIndexImg01"
              />
              <img
                className="mb-[32px] w-[311px] tablet:mb-[80px] tablet:w-[689px] desktop:w-[1110px]"
                src={PortfolioImg03}
                alt="PortfolioImg01"
              />
            </div>
